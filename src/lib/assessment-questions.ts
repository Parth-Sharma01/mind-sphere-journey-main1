...
export const assessmentQuestionPool: AssessmentQuestion[] = [
  ...
  },
  {
    ...
    options: ['I feel overwhelmed and give up', 'I feel stuck initially but try', 'I adapt fairly well', 'I see them as opportunities to grow'],
    scores: [20, 45, 70, 90],
    dimension: 'emotional_resilience',
  },
  {
  ...
  },
  {
    ...
    options: ['I take it personally', 'I\'m defensive initially', 'I try to be open', 'I welcome it and learn'],
    scores: [20, 45, 70, 90],
    dimension: 'emotional_resilience',
  },
  {
  ...
  },
  {
    ...
    options: ['I believe negative thoughts', 'I fight them', 'I usually challenge them', 'I recognize and dismiss them'],
    scores: [15, 40, 70, 90],
    dimension: 'emotional_resilience',
  },
  {
  ...
  },
  {
    ...
    options: ['Not really', 'Some unhealthy ones', 'Mix of healthy and unhealthy', 'Yes, mostly healthy'],
    scores: [15, 35, 65, 90],
    dimension: 'stress_balance',
  },
  {
